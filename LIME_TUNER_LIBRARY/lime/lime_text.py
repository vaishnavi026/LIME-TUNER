...
class LimeTextExplainer(object):
    ...
    def explain_instance(self,
        ...
        data1, yss1, distances1 = self.__data_labels_distances(
            indexed_string, classifier_fn, num_samples,
            distance_metric=distance_metric)
        ...
        for label in labels:
            ...
            (ret_exp.intercept[label],
             ...
             ret_exp.score, ret_exp.naive_score, ret_exp.rf_score, ret_exp.rf_2_score, ret_exp.local_pred, ret_exp.bb_labels, ret_exp.prop_pos, ret_exp.weights) = self.base.explain_instance_with_data(
                data, yss, distances,data1, yss1, distances1, label, num_features,
