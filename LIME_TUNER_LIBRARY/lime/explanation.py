...
class Explanation(object):
    ...
    def __init__(self,
        ...
        self.intercept = {}
        self.score = None
        self.naive_score = None
        self.rf_score = None
        self.rf_2_score = None
        self.local_pred = None
        self.scaled_data = None
        self.prop_pos = None    #proportion of positive samples, Black Box Classifier
        self.bb_labels = []     #weighted labels of neighbourhood samples based on prediction of BB
        self.weights = []
        self.flag = False;
        self.entropy = 0
